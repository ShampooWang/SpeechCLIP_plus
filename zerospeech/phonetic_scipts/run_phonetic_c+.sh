...
do
    ...
    python3 getEmbeddings.py \
        ...
        --model_ckpt "/mnt/md0/user_jeff/Checkpoints/speechclip+/cascaded/flickr/flickr_c+/epoch=62-step=29484-val_recall_mean_10=40.6400.ckpt" \
        --feat_select_idx ${idx} \
        --task_name "phonetic" \
        --run_dev \
    ...
    RESULT="/mnt/md0/user_jeff/zerospeech2021/result/phonetic/flickr_c+/hidden_state_${idx}"
    mkdir -p $RESULT
