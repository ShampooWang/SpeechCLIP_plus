...
do
    ...
    out_dir="/mnt/md0/user_jeff/zerospeech2021/embeddings/COCO_SpeechCLIP_c2/hidden_state_${idx}"
    ...
    RESULT="/mnt/md0/user_jeff/zerospeech2021/result/phonetic/COCO_SpeechCLIP_c2/hidden_state_${idx}"
    mkdir -p $RESULT
