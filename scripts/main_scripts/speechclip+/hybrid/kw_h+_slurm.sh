...
# EXP_ROOT="/mnt/md0/user_jeff/Checkpoints/COCO_h+_small"
EXP_ROOT="/mnt/md0/user_jeff/Checkpoints/COCO_c+_small"
# EXP_ROOT="/mnt/md0/user_jeff/Checkpoints/test"

CFG_FILE="/mnt/md0/user_jeff/audio-visual-ssl/config/KWClip/wavlm/COCO_h+_small.yaml"
# CFG_FILE="/mnt/md0/user_jeff/audio-visual-ssl/config/KWClip/wavlm/Flickr_h+_small.yaml"
