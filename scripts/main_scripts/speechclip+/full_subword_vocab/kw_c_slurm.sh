...
EXP_ROOT="/work/vjsalt22/hsuanfu/audio-visual-ssl/exp/wavlm/full_subword_vocab/Flickr_c2_small"

CFG_FILE="/work/vjsalt22/hsuanfu/audio-visual-ssl/config/KWClip/wavlm/full_subword_vocab/Flickr_c2_small.yaml"
