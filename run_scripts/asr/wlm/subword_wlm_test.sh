...
model_list=("KW_bsz256_WS_multiAtt_c_flickr" "KW_bsz256_WS_integratedM_flickr_c0.5p0.5" "KW_bsz256_WS_p1_flickr")
model_ckpt_list=( \
...
'/work/vjsalt22/atosystem/audio-visual-ssl/exp/old/KW_bsz256_WS_p1_flickr/epoch_131-step_15443-val_recall_mean_1_36.0100.ckpt' \
)
...
do
    ...
    ckpt_path="/work/vjsalt22/hsuanfu/superb_result/lrage_model/subword_asr1k/${model_list[i]}/1.0e-4/dev-clean-best.ckpt"
    python3 run_downstream.py -m evaluate -e $ckpt_path \
            ...
            config.downstream_expert.datarc.decoder_args.lexicon='/work/vjsalt22/hsuanfu/End-to-end-ASR-Pytorch/librispeech-lexicon-1k.txt',, \
            config.downstream_expert.corpus.libri_root='/work/vjsalt22/dataset/LibriSpeech100',, \
