...
#SBATCH --out=logs/superb/train/KS_wavlm_base.log
...
UPSTREAM=wavlm_base # wavlm_base_plus wavlm_large

python3 run_downstream.py -n $EXP_NAME \
    --expdir "/work/vjsalt22/SUPERB/wavlm/KS/${EXP_NAME}" \
    -m train -u $UPSTREAM \
    -d speech_commands \
