...
EXP_ROOT="/mnt/md0/user_jeff/audio-visual-ssl/exp/wavlm/Flickr2_c2_small_trainable"

# CFG_FILE="/mnt/md0/user_jeff/audio-visual-ssl/config/KWClip/train_flickr_kwCLIP_integrated.yaml"
CFG_FILE="/mnt/md0/user_jeff/audio-visual-ssl/config/KWClip/wavlm/Flickr_c2_small.yaml"
